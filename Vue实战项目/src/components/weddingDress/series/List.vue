	...
	export default {
		...
		methods:{
			go_style_list(series_id,brand_id){
				window.open(location.pathname+'#/index/weddingDress/style?brand_id='+brand_id+'&series_id='+series_id)
			},
			gotostyle(series_id,brand_id){
				this.$router.push({path:'/index/weddingDress/style/edit',query:{series_id:series_id,brand_id:brand_id}})
			},
			...
			changseries(series_id,brand_id){
				this.$router.push({path:'/index/weddingDress/series/edit',query:{series_id:series_id,brand_id:brand_id}})
			}
		},
		computed:{
			msg(){
