...
import CommonApi from '../../../api/Common'
	export default {
		...
		methods:{
			...
			changBrand(brand_id){	
				this.$router.push({path:'/index/weddingDress/brand/edit',query:{brand_id:brand_id}})
			},
			goseries(brand_id){
				window.open(location.pathname+'#/index/weddingDress/series?brand_id='+brand_id)
			},
			add_edit_series(brand_id){
				this.$router.push({path:'/index/weddingDress/series/edit',query:{brand_id:brand_id}})
			},
			go_style(series_id){
				window.open(location.pathname+'#/index/weddingDress/style?series_id='+series_id)
			}
		},
		computed:{
			msg(){
