...
import BrandApi from '../../../api/Brand'
	export default {
		...
		methods:{
			...
			addBrand(){	
				this.$router.push({path:'/index/weddingDress/brand/edit'})
			}
		},
		watch:{
			now:function(val, oldVal){
				if(!isNaN(val)){sessionStorage.setItem("brand-now-page",val)}
				BrandApi.getList(this)
			},
